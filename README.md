...
> Открыть эту страницу в [https://kubostrel.github.io/security/](https://kubostrel.github.io/security/)
...
* найдите **https://github.com/kubostrel/security** и импортируйте

## Править этот проект ![Значок статуса сборки](https://github.com/kubostrel/security/workflows/MakeCode/badge.svg)

Редактировать этот репозиторий в MakeCode.

* открыть [https://makecode.microbit.org/](https://makecode.microbit.org/)
* нажмите на **Импорт**, затем **Импорт URL**
* вставьте **https://github.com/kubostrel/security** и нажмите Импорт
...
![Отрисовка в виде блоков](https://github.com/kubostrel/security/raw/master/.github/makecode/blocks.png)
